...
public class PopularTvSeries extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getPopularTvSeries() {
        ...
        service.getPopularTvSeries(new Callback<Tv.TvResult>() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_settings4:
                Intent intent2 = new Intent(this, OnTheAirTv.class);
